...
export default function PlanningPage() {
  ...
  const getCourseForChauffeurAtHour = (chauffeurId: string, hour: number) => {
    return courses.find(course => {
      ...
      const courseHour = new Date(course.dateHeure).getHours()
  ...
  return (
    <div className="flex-1 flex flex-col h-full">
      ...
      {/* Nouveau Planning avec Timeline */}
            ...
            <Card className="h-full">
              ...
              <CardContent className="space-y-3 h-[calc(100%-80px)] overflow-y-auto">
                {getUnassignedCourses().map((course) => (
                  <Card key={course.id} className="p-3 cursor-grab hover:shadow-md transition-shadow">
                ...
                <div className="overflow-auto h-[calc(100%-80px)]">
                  <table className="w-full">
                    <thead className="sticky top-0 bg-background border-b">
                      <tr>
                        <th className="w-32 p-3 text-left text-xs font-medium text-muted-foreground border-r">
                          Chauffeur
                        </th>
                      ...
                      {chauffeurs.map((chauffeur) => (
                        <tr key={chauffeur.id} className="border-b hover:bg-muted/30">
                          ...
                          {generateTimeSlots().map((hour) => {
                            ...
                            return (
                              <td key={hour} className="p-1 border-r text-center">
                                {course ? (
                ...
                <div className="border rounded-lg p-4 bg-muted/50">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center">
                      ...
                      {formatHour(confirmDialog.hour)} le {format(selectedDate, 'dd/MM/yyyy')}
                    </div>
                    <div className="flex items-center">
